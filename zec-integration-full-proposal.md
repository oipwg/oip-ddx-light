...
We’ve worked with large and small companies as well as government and academic institutions on data ranging from scientific records, to influencer content, to property records, to news. Here is a [5 min overview video] (https://youtu.be/i67MHSNhbc4) and some [project highlights + links to apps & demos](https://docs.google.com/document/d/1UEYtFvRbArr7rF-DgrrhyNnKz-Vpbn-N5VwoLUt-KVM/edit) we've done since.
