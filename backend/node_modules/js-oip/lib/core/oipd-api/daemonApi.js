...
class DaemonApi {
  ...
  async getArtifact(txid) {
    ...
    let _res$data$results = _slicedToArray(res.data.results, 1),
  ...
  async getRecord(txid) {
    ...
    let _res$data$results2 = _slicedToArray(res.data.results, 1),
  ...
  async get041Artifact(txid) {
    ...
    if (res && res.data) {
      let _res$data$results3 = _slicedToArray(res.data.results, 1),
  ...
  async getAlexandriaMediaArtifact(txid) {
    ...
    if (res && res.data) {
      let _res$data$results4 = _slicedToArray(res.data.results, 1),
  ...
  async getFloData(txid) {
    ...
    if (res && res.data) {
      let _res$data$results5 = _slicedToArray(res.data.results, 1),
  ...
  async getMultipart(txid) {
    ...
    if (res && res.data) {
      let _res$data$results6 = _slicedToArray(res.data.results, 1),
  ...
  async getHistorianData(txid) {
    ...
    if (res && res.data) {
      let _res$data$results7 = _slicedToArray(res.data.results, 1),
