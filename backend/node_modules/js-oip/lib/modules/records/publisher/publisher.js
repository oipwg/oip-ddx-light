...
class Publisher extends _oipRecord.default {
  ...
  isValid() {
    ...
    if (!this._publisher.floAddress || this._publisher.floAddress === '') {
      return {
        success: false,
        error: 'floAddress is a Required Field! Please set it using `setMainAddress`!'
      };
    }
  ...
  serialize(method) {
    ...
    pub.authorized = undefined; // Remove `pub.info` section

    pub.info = undefined; // Remove `pub.verification` section

    pub.verification = undefined; // setup initial object
    ...
    pubMessage['oip042'][method] = {
      pub,
      signature: this.signature // add json prefix
