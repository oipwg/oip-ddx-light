...
const ECPair = _bitcoinjsLib.default.ECPair;
/**
...
class Address {
  ...
  */
  constructor(address, coin, discover) {
    ...
    this.coin = coin || {
      satPerCoin: 1e8 // Setup internal variables
    ...
    this.lastUpdated = 0;
    this.spentTransactions = []; // Setup EventEmitter to notify when we have changed

    this.event_emitter = new _eventemitter.default(); // Setup Websocket Address updates to keep us always up to date
  ...
  */
  ...
  signMessage(message) {
    ...
    try {
      signature_buffer = _bitcoinjsMessage.default.sign(message, privateKeyBuffer, compressed, messagePrefix);
    } catch (e) {
