...
class DaemonApi {
  ...
  async searchArtifacts(query, limit) {
    ...
    try {
      ...
      throw new Error("Failed to search artifacts for: ".concat(query, " -- ").concat(err));
    }
    ...
    if (res && res.data) {
      ...
      return {
        success: false,
        error: "Missing response data: ".concat(res.data)
      };
    }
  }
  /**
  ...
  async searchArtifactsByType(type, subtype) {
    ...
    for (let i = 0; i < typeArr.length; i++) {
      typeQuery += "".concat(typeQs).concat(typeArr[i]);
    ...
    let query = "(".concat(typeQuery, ") ");

    if (subtype) {
      subtypeQuery += "".concat(AND, " ");
      subtypeQuery += "".concat(subtypeQs).concat(subtype);
      query += subtypeQuery;
    }
  ...
  createQs(args) {
    ...
    for (let i = 0; i < args.length; i++) {
      ...
      if (args[i].operator) {
        ...
        if (args[i].field) {
          query += "".concat(args[i].field, ":\"").concat(args[i].query, "\"");
        } else {
          query += "".concat(args[i].query); // do these need to be wrapped in quotes?
        }
      }
    } // console.log(query)
  ...
  async getArtifact(txid) {
    ...
    try {
      res = await this.index.get("/artifact/get/".concat(txid));
    } catch (err) {
      return new Error("Failed to get artifact: ".concat(txid, " -- ").concat(err));
    }

    if (!res || !res.data) {
      return {
        success: false,
        error: "Missing response data: ".concat(res.data, " for txid ").concat(txid)
      };
    }
    ...
    if (!res.data.results || !Array.isArray(res.data.results) || res.data.results.length < 1) {
      return {
        success: false,
        error: "No results found for txid ".concat(txid)
      };
    }
  ...
  async getRecord(txid) {
    ...
    try {
      res = await this.index.get("/oip042/record/get/".concat(txid));
    } catch (err) {
      return new Error("Failed to get Record: ".concat(txid, " -- ").concat(err));
    }
    ...
    return {
      success: true,
      record: (0, _decoders.decodeArtifact)(record)
    }; // ToDO: OIPDecoder
  }
  /**
  ...
  async getArtifacts(txids) {
    ...
    for (let txid of txids) {
      ...
      try {
        ...
        throw new Error("Failed to get artifacts: ".concat(txids, " -- ").concat(err));
      }
  ...
  async getLatestArtifacts() {
    ...
    try {
      ...
      throw new Error("Failed to get latest artifacts: ".concat(err));
    }
  ...
  async getLatest041Artifacts() {
    ...
    try {
      ...
      throw new Error("Failed to get latest 041 artifacts -- ".concat(err));
    }
  ...
  async get041Artifact(txid) {
    ...
    try {
      res = await this.index.get("/oip041/artifact/get/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get 041 artifact: ".concat(txid, " -- ").concat(err));
    }
  ...
  async get041Artifacts(txids) {
    ...
    for (let txid of txids) {
      ...
      try {
        ...
        throw new Error("Failed to get 041 artifacts: ".concat(txids, " -- ").concat(err));
      }
  ...
  async getLatest042Artifacts() {
    ...
    try {
      ...
      throw new Error("Failed to get latest 042 artifacts: ".concat(err));
    }
  ...
  async getLatestAlexandriaMediaArtifacts() {
    ...
    try {
      ...
      throw new Error("Failed to get latest alexandria media artifacts -- ".concat(err));
    }
  ...
  async getAlexandriaMediaArtifact(txid) {
    ...
    try {
      res = await this.index.get("/alexandria/artifact/get/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get alexandria media artifact: ".concat(txid, " -- ").concat(err));
    }
  ...
  async getAlexandriaMediaArtifacts(txids) {
    ...
    for (let txid of txids) {
      ...
      try {
        ...
        throw new Error("Failed to get alexandria media artifacts: ".concat(txids, " -- ").concat(err));
      }
  ...
  async searchFloData(query, limit) {
    ...
    try {
      ...
      throw new Error("Failed to search flo data for: ".concat(query, " -- ").concat(err));
    }
  ...
  async getFloData(txid) {
    ...
    try {
      res = await this.index.get("/floData/get/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get flo tx: ".concat(txid, " -- ").concat(err));
    }
  ...
  async getMultipart(txid) {
    ...
    try {
      res = await this.index.get("/multipart/get/id/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get multipart by txid: ".concat(txid, " -- ").concat(err));
    }
  ...
  async getMultiparts(ref, limit) {
    let res;
    let querystring = "/multipart/get/ref/".concat(ref);
    ...
    try {
      ...
      throw new Error("Failed to get multiparts by ref: ".concat(ref, " -- ").concat(err));
    }
  ...
  async getHistorianData(txid) {
    ...
    try {
      res = await this.index.get("historian/get/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get historian data by txid: ".concat(txid, " -- ").concat(err));
    }
  ...
  async getLastestHistorianData() {
    ...
    try {
      ...
      throw new Error("Failed to get latest historian data: ".concat(err));
    }
  ...
  async getVersion() {
    ...
    try {
      ...
      throw new Error("Failed to get daemon version: ".concat(err));
    }
  ...
  async getSyncStatus() {
    ...
    try {
      ...
      throw new Error("Failed to get sync status: ".concat(err));
    }
  ...
  async getLatestOip5Records(options) {
    ...
    try {
      ...
      throw new Error("Failed to get latest oip5 records: ".concat(err));
    }
  ...
  async getLatestOip5Templates(options) {
    ...
    try {
      ...
      throw new Error("failed to get latest oip5 templates: ".concat(err));
    }
  ...
  async getOip5Record(txid) {
    ...
    try {
      res = await this.index.get("o5/record/get/".concat(txid));
    } catch (err) {
      return {
        success: false,
        error: err
    ...
    if (res && res.data) {
      ...
      return {
        success: false,
        error: "no data returned from axios response getOip5Record: ".concat(txid)
      };
    }
  }
  /**
  ...
  async getOip5Records(txids) {
    ...
    for (let promise of promiseArray) {
      ...
      try {
        ...
        throw new Error("Failed to get oip5 records: ".concat(err));
      }
  ...
  async getOip5Template(txid) {
    ...
    try {
      res = await this.index.get("o5/template/get/".concat(txid));
    } catch (err) {
      throw new Error("Failed to get oip5 template: ".concat(err));
    }
    ...
    if (res && res.data) {
      ...
      return {
        success: false,
        error: "No data returned from axios request getOip5Template: ".concat(txid)
      };
    }
  }
  /**
  ...
  async getOip5Templates(txids) {
    ...
    for (let promise of promiseArray) {
      ...
      try {
        ...
        throw new Error("Could not get oip5 templates: ".concat(err));
      }
  ...
  async getOip5Mapping(tmplIdentifiers) {
    ...
    try {
      res = await this.index.get("o5/record/mapping/".concat(tmplIdentifiers));
    } catch (err) {
      throw new Error("Failed to get oip5 mappings: ".concat(err));
    }
  ...
  async searchOip5Records(options) {
    ...
    try {
      ...
      throw new Error("Failed to search oip5 records: ".concat(err));
    }
  ...
  async searchOip5Templates(options) {
    ...
    try {
      ...
      throw new Error("Failed to search oip5 templates: ".concat(err));
    }
  ...
  async isVerifiedPublisher(_ref) {
    ...
    const q = "_exists_:record.details.".concat(tmplName, " AND meta.signed_by:").concat(pubAddr);
    let results;
    ...
    if (success) {
      ...
      try {
        res = await _axios.default.get("".concat(verifyEndpoint).concat(txid));
      } catch (err) {
        throw Error("Failed to hit verify api endpoint url: ".concat(verifyEndpoint, " \n ").concat(err));
      }
      ...
      return {
        success: false,
        error: "Did not receive data back from axios request trying to search oip5 verified publisher: ".concat(pubAddr)
      };
    }
  }
