...
class Artifact extends _oipRecord.default {
  ...
  toJSON() {
    ...
    let cloneJSON = JSON.parse(JSON.stringify(artJSON)); // OIPd will not accept artifacts that have storage defined without any files
  ...
  createPreimage() {
    ...
    let preimage = "".concat(this.getLocation() || '', "-").concat(this.getPubAddress(), "-").concat(this.getTimestamp());
  ...
  serialize(method) {
    ...
    let art = artJSON.artifact; // setup initial object
