...
var isArray = __webpack_require__(0),
    ...
    toString = __webpack_require__(36);
...
var basePick = __webpack_require__(29),
...
var basePickBy = __webpack_require__(30),
    hasIn = __webpack_require__(42);
...
var baseHasIn = __webpack_require__(43),
    hasPath = __webpack_require__(44);
...
var SetCache = __webpack_require__(18),
    ...
    createSet = __webpack_require__(59),
...
var lodash_keys = __webpack_require__(7);
...
var isEqual = __webpack_require__(25);
var isEqual_default = /*#__PURE__*/__webpack_require__.n(isEqual);

// EXTERNAL MODULE: ./node_modules/react-fast-compare/index.js
var react_fast_compare = __webpack_require__(26);
var react_fast_compare_default = /*#__PURE__*/__webpack_require__.n(react_fast_compare);

// CONCATENATED MODULE: ./src/deepDiff.js
...
var deepDiff_classifyDiff = function classifyDiff(prev, next, name) {
  if (prev === next) {
    return {
  ...
  if (react_fast_compare_default()(prev, next)) {
    return {
  ...
  var isChanged = function isChanged(key) {
    return prev[key] !== next[key] && !isEqual_default()(prev[key], next[key]);
  };
  var isSameFunction = function isSameFunction(key) {
    var prevFn = prev[key];
    var nextFn = next[key];
    return isFunction_default()(prevFn) && isFunction_default()(nextFn) && prevFn.name === nextFn.name;
  };

  var keys = union_default()(keys_default()(prev), keys_default()(next));
  var changedKeys = filter_default()(keys, isChanged);

  if (changedKeys.length && every_default()(changedKeys, isSameFunction)) {
    return {
      type: DIFF_TYPES.FUNCTIONS,
      name: name,
      prev: pick_default()(prev, changedKeys),
      next: pick_default()(next, changedKeys)
    };
  }
...
// CONCATENATED MODULE: ./src/getDisplayName.js
var getDisplayName = function getDisplayName(ctor) {
...
// CONCATENATED MODULE: ./src/defaultNotifier.js
...
var defaultNotifier = function defaultNotifier(groupByComponent, collapseComponentGroups, displayName, diffs) {
  ...
  diffs.forEach(defaultNotifier_notifyDiff);
...
// CONCATENATED MODULE: ./src/normalizeOptions.js
...
var normalizeOptions_toRegExp = function toRegExp(s) {
  return isString_default()(s) ? new RegExp('^' + s + '$') : s;
};
...
var some = __webpack_require__(8);
var some_default = /*#__PURE__*/__webpack_require__.n(some);

// CONCATENATED MODULE: ./src/shouldInclude.js



var shouldInclude_shouldInclude = function shouldInclude(displayName, _ref) {
  var include = _ref.include,
      exclude = _ref.exclude;

  return some_default()(include, function (r) {
    return r.test(displayName);
  }) && !some_default()(exclude, function (r) {
    return r.test(displayName);
  });
};
// CONCATENATED MODULE: ./src/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "whyDidYouUpdate", function() { return src_whyDidYouUpdate; });
...
function createComponentDidUpdate(displayName, opts) {
  return function componentDidUpdate(prevProps, prevState) {
    ...
    var stateDiff = deepDiff_classifyDiff(prevState, this.state, displayName + '.state');
...
var src_whyDidYouUpdate = function whyDidYouUpdate(React) {
  var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  opts = normalizeOptions_normalizeOptions(opts);
...
/* harmony default export */ var src = __webpack_exports__["default"] = (src_whyDidYouUpdate);
