(function (global, factory) {
...
}(this, (function (exports, React, defaultJss$1) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
  var defaultJss__default = /*#__PURE__*/_interopDefaultLegacy(defaultJss$1);
  ...
  */
  ...
  var require$$0 = /*@__PURE__*/getAugmentedNamespace(reactIs$1);
  ...
  var functionPlugin = function functionPlugin() {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var rule = defaultJss$1.createRule(name, {}, options);
        rule[fnRuleNs] = decl;
        return rule;
      },
  ...
  var observablePlugin = function observablePlugin(updateOptions) {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var style$ = decl;
        var rule = defaultJss$1.createRule(name, {}, options); // TODO
  ...
  function () {
    function GlobalContainerRule(key, styles, options) {
      ...
      this.rules = new defaultJss$1.RuleList(_extends({}, options, {
        parent: this
      }));
  ...
  var px = defaultJss$1.hasCSSTOMSupport && CSS ? CSS.px : 'px';
  var ms = defaultJss$1.hasCSSTOMSupport && CSS ? CSS.ms : 'ms';
  var percent = defaultJss$1.hasCSSTOMSupport && CSS ? CSS.percent : '%';
  /**
  ...
  function jssVendorPrefixer() {
    ...
    function prefixStyle(style) {
      for (var prop in style) {
        ...
        var supportedValue$1 = supportedValue(supportedProp, defaultJss$1.toCssValue(value));
    ...
    function onChangeValue(value, prop) {
      return supportedValue(prop, defaultJss$1.toCssValue(value)) || value;
    }
  ...
  var jss = defaultJss$1.create(create());
  ...
  JssProvider.propTypes = {
    registry: propTypes$1.instanceOf(defaultJss$1.SheetsRegistry),
    jss: propTypes$1.instanceOf(defaultJss__default['default'].constructor),
  ...
  var defaultJss = defaultJss$1.create(create());
